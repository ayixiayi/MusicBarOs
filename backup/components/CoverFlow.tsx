...
export const CoverFlow: React.FC<CoverFlowProps> = ({ songs, currentIndex }) => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-center items-center overflow-hidden">
      ...
      {/* Background Ambient - No Opaque Fill to allow Spectrum through */}
      <div className="absolute inset-0 z-0">
        <img 
          key={activeSong?.id}
          src={activeSong?.coverUrl} 
          className="w-full h-full object-cover blur-[100px] opacity-10 transition-opacity duration-1000 scale-125"
          alt="ambient"
        />
